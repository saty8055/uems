...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDashboardTableTableComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _dashboard_table_table_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./dashboard/table/table.component */
    "./src/app/dashboard/table/table.component.ts");
    /* harmony import */


    var _dashboard_booking_booking_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _dashboard_booking_booking_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./dashboard/booking/booking.component */
    "./src/app/dashboard/booking/booking.component.ts");
    /* harmony import */


    var _dashboard_table_table_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./dashboard/table/table.component */
    "./src/app/dashboard/table/table.component.ts");
  ...
  function srcAppDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      ...
      _createClass(DashboardComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          if (this.router.url.toString().includes("booking")) this.highlight("bookings");else if (this.router.url.toString().includes("table")) this.highlight("tables");
        }
      }, {
        key: "toggleSideBar",
    ...
    var EmployeeComponent = /*#__PURE__*/function () {
      ...
      _createClass(EmployeeComponent, [{
        ...
        value: function list() {
          ...
          this.loader.load();
          this.api.listCustomer().subscribe(function (response) {
        ...
        value: function validateAndAdd() {
          ...
          this.loader.load();
          this.api.addCustomer(funds).subscribe(function (response) {
            ...
            _this5.api.validateResponse(response, function (data) {
              ...
              _this5.bot.success("Customer Added!");
            }, function (error) {
    ...
    var ServicesComponent = /*#__PURE__*/function () {
      ...
      _createClass(ServicesComponent, [{
        ...
        value: function list() {
          ...
          this.loader.load();
          this.api.listMedicines().subscribe(function (response) {
        ...
        value: function validateAndAdd() {
          ...
          var funds = this.form.value;
          this.loader.load();
          this.api.addMedicine(funds).subscribe(function (response) {
            _this9.loader.resume();

            _this9.api.validateResponse(response, function (data) {
              _this9.funds.push(data);

              _this9.form.reset();

              _this9.bot.success("Medicine Added!");
            }, function (error) {
  ...
  /***/
  function srcAppDashboardTableTableComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDashboardTableTableComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TableComponent = /*#__PURE__*/function () {
      function TableComponent(api, bot) {
      ...
      _createClass(TableComponent, [{
        ...
        value: function list() {
          ...
          this.api.listRooms(this.fromDate, this.toDate).subscribe(function (response) {
            _this10.persistedFromDate = _this10.fromDate;
            _this10.persistedToDate = _this10.toDate;
        ...
        value: function book(id) {
          ...
          this.api.book(booking).subscribe(function (response) {
            ...
            _this11.api.validateResponse(response, function (data) {
              _this11.rooms = _this11.rooms.filter(function (room) {
                return room.tableId != id;
              });
            }, function (error) {
              return _this11.bot.fail(error);
            });
          });
        }
      }]);
    ...
    TableComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/table/table.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./table.component.css */
      "./src/app/dashboard/table/table.component.css"))["default"]]
    })], TableComponent);
    /***/
  },
    ...
    var TasksComponent = /*#__PURE__*/function () {
      ...
      _createClass(TasksComponent, [{
        ...
        value: function list() {
          ...
          this.loader.load();
          this.api.listSales().subscribe(function (response) {
        ...
        value: function validateAndAdd() {
          ...
          this.loader.load();
          this.api.addSales(tasks).subscribe(function (response) {
            _this14.loader.resume();

            _this14.api.validateResponse(response, function (data) {
              _this14.funds.push(data);

              _this14.form.reset();

              _this14.bot.success("Sales Added!");
            }, function (error) {
              _this14.bot.fail(error);
            });
          });
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/shadow/Desktop/Sandbox/UE-MS/ue-ms/src/main/ue-ms/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
